      ...
      >
        <div className="max-w-[600px] pt-2">
          ...
          <div className="italic flex  gap-2">
            ...
            {globalState.lang === "en" && (
              <p>
                Mobile phone connectivity may not be ideal in the forest. Maybe
                download the eBook provided below if you have problems with your
                connection.
              </p>
            )}
            {globalState.lang === "de" && (
              <p>
                ...
                Ladet für den Fall der Fälle am besten das unten stehende eBook
                runter, wenn ihr Probleme mit eurem Empfang haben solltet.
              </p>
            )}
          </div>
          <hr className="my-3 text-brown-200 mx-8" />
